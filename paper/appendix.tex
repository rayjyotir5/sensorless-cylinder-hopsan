...
The harness (\texttt{cylinder\_sim/}: parameters, Hopsan driver, sensor model,
observer, sweep, plots), the Hopsan model
(\texttt{hopsan/sensorless\_cylinder\_plant.hmf}), the integration tests, and the
figure-generation scripts accompany this paper in the spike directory.
